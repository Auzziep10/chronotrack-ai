            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col max-h-[95vh]">
                ...
                <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6">
                    <section>
                        ...
                        <div className="mt-4 text-xs text-zinc-600 bg-zinc-50 rounded-lg p-4 border border-zinc-100">
                            <div className="font-bold text-zinc-800 mb-2">How to find your Discord ID on Mobile:</div>
                    ...
                    <div className="pt-2 sticky bottom-0 bg-white grid grid-cols-2 gap-3">
                        <button
                            ...
                            className={`flex items-center justify-center gap-2 font-bold py-3 px-2 text-sm rounded-xl shadow-sm transition-all active:scale-95 border-2 ${testResult === 'success' ? 'bg-zinc-50 text-zinc-800 border-zinc-200' : testResult === 'error' ? 'bg-red-50 text-red-700 border-red-200' : 'bg-white text-zinc-900 border-zinc-100 hover:bg-zinc-50 disabled:opacity-50 disabled:cursor-not-allowed'}`}
                        >
                        ...
                        <button
                            type="submit"
                            className="flex items-center justify-center gap-2 bg-zinc-800 hover:bg-zinc-700 text-white text-sm font-bold py-3 px-2 rounded-xl shadow-md transition-all active:scale-95"
                        >
