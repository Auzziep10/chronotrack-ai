...
CRITICAL RULES FOR MULTIPLE TASKS, TIMES & ASSIGNEES:
...
2. If a task is assigned to multiple people (e.g., "Joe and Anna to do a task"), you MUST create a separate task object for EACH person. Do not use combined names like "Joe and Anna" in "assignedToName".
3. Carefully apply the specified or implied times to each distinct task.
4. ALL TIMES MUST BE 24-HOUR FORMAT (HH:mm). 
5. INFER AM/PM CAREFULLY: We work from 6 AM to 8 PM. If the user says "at 2", they mean 2 PM ("14:00"). If they say "1-2", they mean 1 PM to 2 PM ("13:00" to "14:00"). If they say "10-12", they mean 10 AM to 12 PM ("10:00" to "12:00").
